...
public class TetrisBasics {
	...
	public static void main(String[] args) {
		...
		StdDraw.setCanvasSize(450, 550);
		// set the scale of the coordinate system
		StdDraw.setXscale(-5.5,gridWidth - 0.5);
		StdDraw.setYscale(-0.5, gridHeight - 0.5);
		StdDraw.setPenColor(StdDraw.BLACK);

		StdDraw.text(0.5, 0.3, "SCORE");
		...
		Tetromino t = createIncomingTetromino(gridHeight, gridWidth);
		...
		while (true)  {
			...
			if (createANewTetrominoL) {
				...
				t = createIncomingTetromino(gridHeight, gridWidth);
			}
			...
			StdDraw.setPenColor(StdDraw.BLACK);
			StdDraw.line(-0.5,-0.5, -0.5, 20);
			StdDraw.text(-3, 18, "SCORE:");
			StdDraw.text(-3, 8, "NEXT PIECE:");
			t.display();
